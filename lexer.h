...
private:
	const std::unordered_map<std::string, std::string> KEYWORDS_TO_TOKENS = {
		...
		{Keywords::OR, Tokens::OR}, {Keywords::STRING, Tokens::STRING}, {Keywords::INTEGER, Tokens::INTEGER}, {Keywords::REAL, Tokens::REAL}, {Keywords::MOD, Tokens::MOD},
	...
	const std::unordered_map<char, std::string> SYMBOLS_TO_TOKENS{
		...
		{Keywords::COLON, Tokens::COLON}, {Keywords::LBRACKET, Tokens::RBRACKET}, {Keywords::RBRACKET, Tokens::RBRACKET}, {Keywords::LSQUARE, Tokens::LSQUARE}, 
